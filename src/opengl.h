...
typedef union
{
	void (*veci)(GLint location, GLsizei count, const GLint *value); // glUniform*iv function
	void (*vecf)(GLint location, GLsizei count, const GLfloat *value); // glUniform*fv function
	void (*mat)(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value); // glUniformMatrix*fv function
} 
UniformFunc;
